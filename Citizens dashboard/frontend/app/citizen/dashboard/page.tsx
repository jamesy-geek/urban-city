...
const DynamicDashboardMap = dynamic<{ activeScenario: string | null }>(() => import("@/components/DashboardMap"), {
  ssr: false,
...
export default function ConsolidatedDashboard() {
  ...
  const STATS = [
    { label: t("Help Requests"), value: "24", icon: Info, color: "#3b82f6" },
    { label: t("Raised Tickets"), value: "156", icon: AlertCircle, color: "#f59e0b" },
    { label: t("Resolved"), value: "112", icon: CheckCircle, color: "#10b981" },
    { label: t("Unresolved"), value: "44", icon: Clock, color: "#ef4444" },
  ];
