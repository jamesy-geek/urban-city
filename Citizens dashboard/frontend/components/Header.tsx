  ...
  return (
    <header style={{
      ...
      <nav style={{ display: "flex", gap: "32px", alignItems: "center" }}>
        <Link href="/citizen/dashboard" style={{ fontWeight: 500 }}>{t("Dashboard")}</Link>
        <Link href="/citizen/map" style={{ fontWeight: 500 }}>{t("City Map")}</Link>
        <a href="/ai_chatbot/index.html" style={{ fontWeight: 500 }}>{t("CityMind AI")}</a>
        <Link href="/citizen/forms" style={{ fontWeight: 500 }}>{t("Civic Forms")}</Link>
        <Link href="/citizen/support" style={{ fontWeight: 500 }}>{t("Support")}</Link>
      </nav>
